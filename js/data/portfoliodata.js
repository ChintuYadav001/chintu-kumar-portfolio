...
export const portfolioData = {
  personalInfo: {
    ...
    heroBio: "Computer Science (AI & Data Science) undergraduate specialized in Python, SQL pipeline design, and interactive Power BI dashboards. Proven experience preprocessing 50,000+ records and transforming raw business data into automated metrics and actionable executive insights.",
    bio: "An enthusiastic and detail-oriented <strong>Data Analyst</strong> with a strong foundation in Python, SQL, Power BI, and exploratory data analysis. Eager to apply critical thinking and automated analytical pipelines in a collaborative corporate environment.",
    location: "Greater Noida / Delhi NCR, India (Open to Remote & Relocation)",
    email: "chintukumaredu00@gmail.com",
    phone: "+91 7763917713",
    ...
    socials: {
      ...
      linkedin: "https://linkedin.com/in/chintu-yadav-767909190",
      whatsapp: "https://wa.me/917763917713",
      email: "mailto:chintukumaredu00@gmail.com",
    ...
    experience: [
      {
        ...
        kpis: [
          ...
          { label: "Time Saved via ETL", value: "40%" },
          { label: "EDA Visualizations", value: "10+" }
        ],
        highlights: [
          "Cleaned and preprocessed 5+ multi-domain business datasets (50,000+ total rows) using Python (Pandas, NumPy), identifying missing values, removing duplicates, and handling outliers to lift overall data quality by an estimated 30%.",
          "Engineered exploratory data analysis (EDA) pipelines and statistical summaries to uncover customer behavioral KPIs and revenue correlations, presenting findings to a 4-person cross-functional team.",
          "Constructed 10+ statistical charts and interactive visualizations using Matplotlib & Seaborn, translating complex analytical trends into clear, decision-ready insights for stakeholders.",
          "Automated recurring data ingestion and cleansing procedures using modular, reusable Python functions, slashing manual preprocessing time by ~40%."
        ],
        skills: ["Python", "Pandas", "NumPy", "EDA", "Data Cleaning", "Matplotlib", "Seaborn", "Feature Engineering", "ETL Automation"]
      }
    ],
    education: [
      {
        role: "B.Tech, Computer Science (AI & Data Science)",
      ...
      },
      {
        ...
        organization: "Paramount Academy (CBSE)",
  ...
  skills: [
    ...
    { name: "MySQL (Joins & Subqueries)", category: "devops", level: 90, icon: "database" },
  ...
  projects: [
    {
      id: "project-rfm",
      title: "Customer Behavior & RFM Segmentation Analysis",
      category: "fullstack",
      categoryLabel: "Python / Analytics",
      summary: "Cleaned and analyzed 10,000+ customer transaction records, engineering RFM (Recency, Frequency, Monetary) features to segment customers into 5 value tiers.",
      tags: ["Python", "Pandas", "NumPy", "Matplotlib", "Seaborn", "RFM"],
      ...
      details: {
        ...
        architecture: "Data cleansing with Pandas, feature extraction calculating days since last purchase, purchase frequency, and total spend, followed by quartile scoring into 5 customer tiers.",
        keyFeatures: [
          "Processed and cleaned 10,000+ customer transaction rows",
          "Engineered RFM scores segmenting users into Champions, Loyalists, At Risk, and Hibernating tiers",
          "Identified high-value segments (~20% of customers driving 60%+ of total revenue)",
          "Surfaced targeted retention and reactivation strategies for marketing teams"
        ]
      }
    },
    {
      id: "project-sales",
      title: "Sales Performance Analysis & Power BI Dashboard",
      category: "frontend",
      categoryLabel: "SQL / Power BI",
      summary: "Wrote SQL queries (joins, aggregations, window functions) to analyze the Superstore dataset (9,800+ records) and built an interactive Power BI dashboard.",
      tags: ["SQL", "Power BI", "DAX", "Python", "Pandas", "Excel"],
      liveUrl: "https://github.com/ChintuYadav001",
      githubUrl: "https://github.com/ChintuYadav001",
      details: {
        ...
        keyFeatures: [
          "Crafted complex SQL queries utilizing window functions, subqueries, and multi-table joins",
          "Analyzed 9,800+ historical sales records across multiple geographic regions",
          "Engineered an interactive Power BI dashboard featuring 5+ dynamic KPI visuals",
          "Identified 3+ actionable improvement areas to optimize unprofitable categories and shipping lags"
        ]
      }
    },
    {
      id: "project-traffic",
      title: "Website Traffic & Conversion Analysis",
      category: "ai",
      categoryLabel: "EDA / Insights",
      summary: "Cleaned and analyzed website traffic data spanning thousands of sessions, covering users, bounce rate, session duration, and top landing/exit funnels.",
      ...
      details: {
        ...
        keyFeatures: [
          "Analyzed web analytics session data across thousands of visitors",
          "Isolated the top 5 landing and exit pages to pinpoint friction points",
          "Compared referral channels (Organic, Direct, Social, Paid) against bounce rates",
          "Formulated UX recommendations projected to improve conversion and on-page engagement"
        ]
      }
    }
  ],
  ...
  visitorAlert: {
    enabled: true,
    ownerEmail: "chintukumaredu00@gmail.com",
